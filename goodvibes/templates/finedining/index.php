...
<?php if($bannerwidth=="top") { include dirname(__FILE__).DIRECTORY_SEPARATOR.'framework/banner2.php'; } ?>
<div id="<?php if($banner_check AND $bannerwidth=="top") { echo "header2-outer"; } else { echo "header-outer"; } ?>" class="clr">
<div id="header-inner">
<div id="logo"><img class="logo" src="<?php echo $this->baseurl; ?>/<?php echo "$logo"; ?>" /></div>
<?php include dirname(__FILE__).DIRECTORY_SEPARATOR.'framework/toolbar.php'; ?>
</div>
</div>
<?php if($bannerwidth=="fix" OR $bannerwidth=="wide") { include dirname(__FILE__).DIRECTORY_SEPARATOR.'framework/banner.php'; } ?>
